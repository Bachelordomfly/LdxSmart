...
class clearance_customs(object):

    menu1_loc = (By.LINK_TEXT, '进口')
    menu2_loc = (By.LINK_TEXT, '清关')
    table_loc = (By.ID, 'fd47d655-ac67-4208-afdd-c315684e2edf-left-body')
    send_loc = (By.ID, '7dd93118-c33e-41c1-a09c-80e5fb732751')
        ...
        for i in range(len(arr)):
            for j in range(len(arr[i])):
                if queryContent == arr[i][j]:
                    ...
                    try:
                        checkbox_xpath = '//*[@id="fd47d655-ac67-4208-afdd-c315684e2edf-left-body"]/tbody/tr[' + str(i+1) + ']/td[1]/input'
